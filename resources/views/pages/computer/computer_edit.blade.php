...
@section('title', 'Computer Edit | ITCS')
@section('title-sub', 'Computer Edit')
{{-- @section('breadcrumb')
...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            <form class="row g-3" method="post" action="/komputer/update/{{$komputer->id}}">
                {{ csrf_field() }}
                {{method_field('PUT')}}
                <div class="col-md-4">
