...
<body>
    ...
    <table border="" width="700px" class="table-1">
        <tr>
            ...
            <td width="230px">: &nbsp;{{$eriwayat[0]->hd1_merk}}&nbsp;{{$eriwayat[0]->hd1_kapasitas}} GB</td>
        </tr>
        <tr>
            <td width="150px">Processor</td>
            <td width="200px">: &nbsp;{{$eriwayat[0]->p_merk}} {{$eriwayat[0]->p_tipe}} {{$eriwayat[0]->p_jenis}} </td>
            <td width="120px">Hardisk Drive 2</td>
            <td width="230px">: &nbsp;{{$eriwayat[0]->hd2_merk}}&nbsp;{{$eriwayat[0]->hd2_kapasitas}} GB</td>
        </tr>
        <tr>
            <td width="150px">Mainboard</td>
            <td width="200px">: &nbsp;{{$eriwayat[0]->m_merk}} {{$eriwayat[0]->m_tipe}}</td>
            <td width="120px">Graphic Card</td>
            <td width="230px">: &nbsp;{{$eriwayat[0]->vga_external}}</td>
        </tr>
        <tr>
            ...
            <td width="230px">: &nbsp;{{$eriwayat[0]->lan_mac}}</td>
        </tr>
    </table>
    <br>
